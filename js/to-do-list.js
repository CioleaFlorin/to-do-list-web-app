window.ToDoList = {
  ...
  getItemTableRow:function (item) {
        ...
        return` <tr>
            ...
            <td><a href="#" class="delete-item" data-id="${item.id}"> <i class="far fa-trash-alt"></i> </a>
        </tr>`
    ...
    bindEvents: function () {
        ...
        //delegate is necessary because our checkbox is dynamically injected in the page
        //not present from the beginning, on page load
